#!/usr/bin/env bash
# Compiles probe.c into $1/oversize-composite-probe. No push -- see dev-tools/probes-app/.
set -euo pipefail
...
docker run --rm --user "$(id -u):$(id -g)" -e HOME=/tmp \
  ...
  -o "/workspace/out/oversize-composite-probe"

printf '%s\n' "$out_dir/oversize-composite-probe"
